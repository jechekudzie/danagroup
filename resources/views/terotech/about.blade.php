            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="service-details-wrap">
                        ...
                        <h2 style="color:#ff8a00">TEROTECH CONSTRUCTION</h2>
                        <p style="color:black;">
                            Terotech Construction Limited stands as a testament to Dana Holdings’ commitment to excellence
                            in the Zambian construction and waste management sectors. Established in 2002, Terotech has been
                            at the forefront of infrastructure development, proudly contributing to Zambia’s economic
                            resurgence. Our parent company, Dana Holdings, founded in 1997, has nurtured Terotech into a
                            formidable force with a robust US$ 4 Million asset base.
                        </p>
                        <p style="color:black;">
                            At Terotech, we employ a dynamic and proactive approach to construction. Our dedicated team of
                            qualified engineers and marketing officers ensures that every project we undertake is viable,
                            efficient, and completed to the highest standards. Our meticulous planning, critical path
                            analysis, and rigorous monitoring ensure we deliver on our promises, on time and on budget.
                        </p>

                        <hr />
                        <h4 style="color:black" class="subtitle">Commitment to Quality</h4>
                        <p style="color:black;">
                            We uphold the highest standards of quality assurance, aligning our practices with both local and
                            international standards. Through continuous skills and management training, we ensure our team
                        ...
                        <p style="color:black;">
                            ...
                            state-of-the-art disposal tankers and a rapid response team, we've secured long-term contracts
                            with prestigious clients, including the American and British embassies, and adhere strictly to
                        ...
                        <p style="color:black;">
                            Terotech’s success is driven by our skilled and experienced management team, who bring over two
                        ...
                        <p style="color:black;">
                            As a key component of Dana Holdings, Terotech Construction Limited offers unmatched construction
                            and project management services. Our vision is not only to build structures but also to forge
