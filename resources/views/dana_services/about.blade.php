            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="service-details-wrap">
                        ...
                        <h2>DANA SERVICES</h2>
                        <p style="color:black;">
                            Since its inception in the early 1980s, Dana Services Limited has been a vanguard of industrial
                            and commercial innovation. Incorporated in 1990, our journey has been marked by rapid growth
                            fuelled by a commitment to innovation and diversification. As a wholly Zambian-owned entity, we
                        ...
                        <p style="color:black;">
                            Our operations are backed by a professional workforce exceeding 110 individuals, ranging from
                            business managers, engineers, supply chain experts, to technicians. Together, they ensure the
                        ...
                        <p style="color:black;" class="last-para">
                            Dana Services Limited has cultivated a prestigious clientele, including Konkola Copper Mines,
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 align-self-center">
                                ...
                                <p style="color:black;" class="last-para">
                                    ...
                                    after-sales services to ensure prolonged equipment life and maximum value. Our services
                                    include:</p><br />
                                <ul class="list-inner-wrap">
                        ...
                        <p style="color:black;" class="last-para">
                            Our warehouses in Lusaka, the Copperbelt, and Mazabuka are always stocked, minimizing machine
                            downtime due to part shortages. For parts not immediately available, our expedited supply chain
                            ensures a rapid turnaround, with DHL courier services delivering within five days, air freight
                            within eight days, and sea freight within 30 days.
                        </p>
                        <br/>

                        <p style="color:black;" class="last-para">
                            For a detailed look at our spares, parts, and associated pricing, please refer to our attached
